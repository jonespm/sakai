...
public class TranslationsController {
    ...
    public Translations getSakaiTranslation(String langCode, String session) throws IOException {
        ...
        try{
            URL url = new URL(rubricsConfiguration.getIntegration().getSakaiRestUrl() + "i18n/getI18nProperties?sessionid=" + session + "&locale=" + langCode +  "&resourceclass=org.sakaiproject.rubrics.logic.RubricsService&resourcebundle=rubricsMessages");
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
